...
const TeamMember: React.FC<TeamMemberProps> = ({ name, role, image, delay }) => {
  return (
    <div 
      className="flex flex-col items-center item-appear" 
      style={{ animationDelay: `${delay}ms` }}
    >
      <div className="relative mb-5 rounded-xl overflow-hidden group">
        <div className="aspect-w-1 aspect-h-1 w-full h-60 md:h-72 object-cover">
          <img 
            src={image} 
            alt={name} 
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-all-300 flex items-end justify-center">
          <div className="flex space-x-5 p-5">
            <a href="#" className="text-white hover:text-primary transition-all-200">
...
const Team = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1566492031773-4f4e44671857?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80",
      delay: 300
    },
    {
      name: "Emma Wilson",
      ...
      <div className="content-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-slate-600">
            The passionate individuals behind FindFuse committed to reuniting people with their lost items.
          </p>
        </div>
